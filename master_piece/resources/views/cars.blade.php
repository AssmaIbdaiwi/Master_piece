        ...
        <select class="form-control" name="location_from">
         ...
         <select class="form-control" name="location_to">
          ...
          <select name="passengers_numbers" class="form-control">
                ...
                <div class="col-md-2">
                  <button class="btn btn-primary w-75" style="background-color:#ffd322; border-color:#ffd322 " type="submit" >Search</button>
                </div>
              </div>
            </div>
          </div>
           ...
           <div class="row">
            <div class="col-lg-4 col-md-12">
              ...
              <div class="col-lg-8 col-md-12">
               ...
               <div class="float-end">
                 <img  src="{{asset('upload/'.$cars->driver_image )}}" id="user-avatar" alt=""> </div>
                 <div class="price">
                  ...
                  {{-- <a class=" button float-end" href="#">View </a> <br><br> --}}
                   ...
                   <div class="">
                     <ul class="list-inline">
                       ...
                       <li><i class="fas fa-car-side"></i> Available: {{$cars->passengers_numbers}} chair</li>
                       <li><i class="fas fa-luggage-cart"></i> Luggage: {{$cars->booking_luggages}}</li>
