            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                 ...
                 <h4 style="padding-bottom: 1%">Driver Information</h4>
                    <form class="forms-sample" action="{{route('dashboardCar.store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                   ...
                   <div class="row">
                     {{-- <div class="form-group"> --}}
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Driver First Name" name="driver_fname" required>
                          </div>
                    {{-- </div> --}}
                      ...
                      {{-- <div class="form-group"> --}}
                       <div class="col form-group">
                              <label for="exampleSelectGender">Driver Last Name</label>
                                    <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Driver Last Name" name="driver_lname" required>
                        </div>
                     {{-- </div> --}}
...
<div class="col form-group">
      ...
      <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Driver Last Name" name="driver_email" required >
    </div>
    {{--
  </div> --}}
...
<label for="male"> male
    <input class="" type="radio" id="male" name="gender" value="male" required></label>
  <label for="female">female
    <input class="" type="radio" id="female" name="gender" value="female"required></label>
    </div></div>
    {{--
  </div> --}}
...
<div class="row">
                      <div class="col form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Car number" name="car_number" required>
                      </div>
                      <div class="col form-group">
                        <label for="exampleInputPassword4">Car model</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" placeholder="Car model" name="car_model" required>
                      </div>
</div>
  ...
  <div class="row">                    
                      <div class="col form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputCity1" placeholder="Car color" name="car_color" required>
                      </div>
                      <div class="col form-group">
                        <label for="exampleTextarea1">Car description</label>
                        <textarea class="form-control" id="exampleTextarea1" rows="4"  name="car_description" required></textarea>
                      </div>
    </div>        
    <div class="col form-group">
