...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/cardealer/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jul 2022 08:27:29 GMT -->
<head>
<meta charset="utf-8">
...
<ul>  <!-- SLIDE  -->
    ...
    <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
      ...
      data-responsive_offset="on"
            ...
            style="z-index: 5; white-space: nowrap; font-size: 120px; line-height: 120px; font-weight: 900; color: rgba(255, 255, 255, 1.00);font-family:Roboto;text-transform:uppercase;">Road & </div>
    ...
    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1"
      ...
      data-responsive_offset="on"
            ...
            style="z-index: 6; white-space: nowrap; font-size: 50px; line-height: 50px; font-weight: 700; color: rgba(255, 255, 255, 1.00);font-family:Roboto;">2021 nsx </div>
    ...
    <div class="tp-caption   tp-resizeme rs-parallaxlevel-1"
      ...
      data-responsive_offset="on"
            ...
            style="z-index: 7;"><img src="revolution/assets/2bd73-logo.jpg" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
    ...
    <div class="tp-caption   tp-resizeme"
      ...
      data-responsive_offset="on"
            ...
            style="z-index: 8;"><img src="revolution/assets/a34db-car-01.png" alt="" data-ww="auto" data-hh="auto" data-no-retina> </div>
...
<section class="welcome-2 page-section-ptb bg-4">
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-md-6">
        <div class="content-box text-center">
          <div class="box-info h-100">
            ...
            <h5>New Vehicles</h5>
            <p>Get yourself nice and relaxed and settled. Concentrate on your breathing, engage in the</p>
            </div>
          <a href="#">Read more</a>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="content-box text-center active">
          <div class="box-info h-100">
            <i class="glyph-icon flaticon-electrical-service"></i>
            <h5>Vehicles Service</h5>
            <p> about something that you know you need to be doing, but are not. Then with that thing</p>
            </div>
          <a href="#">Read more</a>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="content-box mb-4 mb-md-0 text-center">
          <div class="box-info h-100">
            ...
            <h5>Vehicles Parts</h5>
            <p>You will begin to realize why this exercise is called the Dickens Pattern reference</p>
            </div>
          <a href="#">Read more</a>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="content-box mb-0 text-center">
          <div class="box-info h-100">
            ...
            <h5>Old Vehicles</h5>
            <p>Scrooge some different futures as you notice that the idea of this exercise is hypnotize </p>
            </div>
          <a href="#">Read more</a>
     ...
     <div class="col-lg-3 col-md-6">
       <div class="feature-box text-center">
          ...
          <div class="content">
            ...
            <p> Galley of type lorem Ipsum is simply dummy text of the printin  k a type</p>
          </div>
        </div>
     </div>
     <div class="col-lg-3 col-md-6">
       <div class="feature-box text-center mb-4 mb-md-0">
          ...
          <div class="content">
            <h6>AUTO ELECTRIC</h6>
            <p>Simply dummy lorem Ipsum is text of the printin  k a galley of type and</p>
          </div>
        </div>
     </div>
     <div class="col-lg-3 col-md-6">
       <div class="feature-box text-center mb-0">
          ...
          <div class="content">
            <h6>transmission</h6>
            <p>Dolorem voluptates is simply dummy text of the printin  k a galley of type</p>
          </div>
        </div>
     </div>
   </div>
   ...
   <div class="row">
     <div class="col-md-12">
       <div class="owl-carousel" data-items="5" data-md-items="5" data-sm-items="3" data-xs-items="1" data-space="0">
          <div class="item">
            <img class="img-fluid" src="images/clients/01.png" alt="">
          </div>
          <div class="item">
            <img class="img-fluid" src="images/clients/02.png" alt="">
          </div>
          <div class="item">
            <img class="img-fluid" src="images/clients/03.png" alt="">
          </div>
          <div class="item">
            <img class="img-fluid" src="images/clients/04.png" alt="">
          </div>
          <div class="item">
            <img class="img-fluid" src="images/clients/05.png" alt="">
          </div>
          <div class="item">
            <img class="img-fluid" src="images/clients/06.png" alt="">
          </div>
          <div class="item">
            <img class="img-fluid" src="images/clients/07.png" alt="">
          </div>
          <div class="item">
            <img class="img-fluid" src="images/clients/08.png" alt="">
          </div>
       </div>
     </div>
    </div>
...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/cardealer/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jul 2022 08:28:58 GMT -->
</html>
