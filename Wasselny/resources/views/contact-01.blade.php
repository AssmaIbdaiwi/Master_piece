...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/cardealer/contact-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jul 2022 08:39:37 GMT -->
<head>
<meta charset="utf-8">
        ...
        <ul class="menu-links">
            ...
            <li class="active"><a href="javascript:void(0)"> Contact <i class="fa fa-angle-down fa-indicator"></i></a>
                ...
                <ul class="drop-down-multilevel right-menu">
                   <li class="active"><a href="contact-01.html">contact 01</a></li>
                   <li><a href="contact-02.html">contact 02</a></li>
                </ul>
            </li>
            <li>
